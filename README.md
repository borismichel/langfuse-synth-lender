...
- **~10–12k traces in ~1,150 sessions** over 30 days — sessions/day driven (~50
  ...
  business hours with lunch dip and Friday-afternoon decline, ~12% German sessions,
  48 named analysts (Zipf-like), 1–3% tool errors **with retry spans**, a handful of
